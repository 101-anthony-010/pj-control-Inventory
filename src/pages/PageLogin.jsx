...
const PageLogin = () => {
  ...
  return (
    <section className="flex justify-center items-center h-screen">
      ...
      <form className='shadow-xl absolute w-[350px] top-1/2 -translate-y-1/2 grid left-10 translate-x-10 gap-4 bg-white p-4 rounded-md'  onSubmit={handleSubmit(submit)} action="" >
