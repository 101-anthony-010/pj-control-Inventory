    ...
    <>
      ...
      <section className='ml-[100px] px-10 mt-[80px]'>
        ...
        <section className='text-center my-4 flex justify-between items-center'>
          <h2 className='font-bold text-2xl'>Registro de Marcas y Modelos</h2>
        ...
        <thead className='bg-gray-200'>
          <tr>
            ...
            <th className='p-2 w-32 border border-white'>Marca</th>
            <th className='p-2 w-32 border border-white'>Modelo</th>
        ...
        <tbody>
          {
            models?.map( item => (
                <tr key={item.id}>
                  ...
                  <th className='border border-black p-2 w-32 uppercase'>{handleNameMarca(item.marcaId)}</th>
